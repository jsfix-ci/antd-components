...
var useL10n = function useL10n() {
  var _useContext = (0, _react.useContext)(_Locales.LocaleContext),
  ...
  try {
    ...
    console.error("locale \"".concat(locale, "\" not exist. fallback to \"").concat(_Locales.DEFAULT_LOCALE, "\""));

    var _antdL10n = require("antd/lib/locale/".concat(_Locales.DEFAULT_LOCALE, ".js"))["default"];

    var _localL10n = require("./".concat(_Locales.DEFAULT_LOCALE, ".js"));
