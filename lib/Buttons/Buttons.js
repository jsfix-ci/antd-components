...
exports.BasketButton = exports.SettingsButton = exports.UndoButton = exports.CloseButton = exports.CancelButton = exports.SaveButton = exports.SearchButton = exports.ReloadButton = exports.EditButton = exports.DeleteButton = exports.AddButton = exports.Button = void 0;
...
var DeleteButton = function DeleteButton(_ref2) {
  var _ref2$icon = _ref2.icon,
      ...
      children = _ref2$children === void 0 ? 'Edit' : _ref2$children,
...
var EditButton = function EditButton(_ref3) {
  var _ref3$icon = _ref3.icon,
      ...
      children = _ref3$children === void 0 ? 'Delete' : _ref3$children,
...
var SearchButton = function SearchButton(_ref5) {
  var _ref5$icon = _ref5.icon,
      icon = _ref5$icon === void 0 ? 'search' : _ref5$icon,
      _ref5$children = _ref5.children,
      children = _ref5$children === void 0 ? 'Search' : _ref5$children,
...
var SaveButton = function SaveButton(_ref6) {
  var _ref6$icon = _ref6.icon,
      icon = _ref6$icon === void 0 ? 'save' : _ref6$icon,
      _ref6$children = _ref6.children,
      children = _ref6$children === void 0 ? 'Save' : _ref6$children,
...
var CancelButton = function CancelButton(_ref7) {
  var _ref7$icon = _ref7.icon,
      icon = _ref7$icon === void 0 ? 'close' : _ref7$icon,
      _ref7$children = _ref7.children,
      children = _ref7$children === void 0 ? 'Cancel' : _ref7$children,
...
var CloseButton = function CloseButton(_ref8) {
  var _ref8$icon = _ref8.icon,
      ...
      children = _ref8$children === void 0 ? 'Close' : _ref8$children,
...
var UndoButton = function UndoButton(_ref9) {
  var _ref9$icon = _ref9.icon,
      icon = _ref9$icon === void 0 ? 'rollback' : _ref9$icon,
      _ref9$children = _ref9.children,
      children = _ref9$children === void 0 ? 'Undo' : _ref9$children,
...
var SettingsButton = function SettingsButton(_ref10) {
  var _ref10$icon = _ref10.icon,
      icon = _ref10$icon === void 0 ? 'setting' : _ref10$icon,
      _ref10$children = _ref10.children,
      children = _ref10$children === void 0 ? 'Settings' : _ref10$children,
...
var BasketButton = function BasketButton(_ref11) {
  var _ref11$icon = _ref11.icon,
      icon = _ref11$icon === void 0 ? 'shopping-cart' : _ref11$icon,
      _ref11$children = _ref11.children,
      children = _ref11$children === void 0 ? 'Add To Basket' : _ref11$children,
