...
var getInput = function getInput(fieldType) {
  ...
  switch (fieldType) {
    ...
    case 'image':
      return _react["default"].createElement(_DataEntry.Upload, fieldProps);

    case 'html':
      return _react["default"].createElement(_DataEntry.Editor, null);

    case 'object':
      return _react["default"].createElement(_DataEntry.CodeMirror, null);

    case 'list':
      return _react["default"].createElement(_DataEntry.ListField, null);
    ...
    case 'select':
      return _react["default"].createElement(_DataEntry.Select, _extends({
        style: {
          width: '100%'
        }
      }, fieldProps));
    ...
    case 'string':
    default:
      return _react["default"].createElement(_antd.Input, fieldProps);
  }
};
