  ...
  return _react["default"].Children.map(columns, function (child) {
    ...
    switch (fieldType) {
      ...
      case 'image':
        ...
        })(_react["default"].createElement(_src.Upload, config)));
      ...
      case 'html':
        ...
        })(_react["default"].createElement(_src.Editor, null)));
      ...
      case 'object':
        ...
        })(_react["default"].createElement(_src.CodeMirror, null)));
      ...
      case 'list':
        ...
        })(_react["default"].createElement(_src.ListField, null)));
