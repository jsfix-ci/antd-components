...
var ImagePreview = function ImagePreview(_ref2) {
  ...
  if (Array.isArray(data)) {
    ...
    if (data.length > 1) {
      ...
      }, "(", data.length - 1, " ", (0, _Locales.useL10n)().Form.moreText, ")");
    }
  } else {
    url = data.url;
    title = data.name;
...
var getDisplay = function getDisplay(_ref3) {
  var children = _ref3.children,
      ...
      value = _ref3.value,
      _ref3$fieldProps = _ref3.fieldProps,
      fieldProps = _ref3$fieldProps === void 0 ? {} : _ref3$fieldProps;
  ...
  switch (fieldType) {
    ...
    case 'object':
      return _react["default"].createElement(CodeSnippet, {
        link: 'object'
      }, (0, _helper.prettifyJson)(value, 2));
    ...
    case 'string':
      return (0, _helper.truncateText)(value, maxLength);

    case 'number':
      return value;

    case 'select':
      return fieldProps.options.find(function (o) {
...
var renderForm = function renderForm(props, columns) {
  return _react["default"].Children.map(columns, function (child) {
    return _react["default"].createElement(_DataEntry.FormItem, _extends({}, child.props, {
      form: props.form
    }));
  });
};
