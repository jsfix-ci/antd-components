...
var BaseGrid = function BaseGrid(props) {
  ...
  var renderEditForm = function renderEditForm() {
    ...
    }, _react["default"].createElement(_Buttons.BackButton, {
      onClick: onBackClick
  ...
  var getToolbar = function getToolbar() {
    return function () {
      return _react["default"].createElement(_react.Fragment, null, _react["default"].createElement(_Buttons.AddButton, {
        disabled: isEditing,
        onClick: onAddClick
      }), _react["default"].createElement(_Buttons.EditButton, {
        disabled: isEditing || selectedRowKeys.length !== 1,
        onClick: onEditClick
      }), _react["default"].createElement(_Buttons.DeleteButton, {
