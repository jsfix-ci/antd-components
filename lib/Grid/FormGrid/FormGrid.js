...
var FormGrid = _antd.Form.create()(function (props) {
  var idProperty = props.idProperty,
      ...
      restProps = _objectWithoutProperties(props, ["idProperty", "dataSource", "onAddRowClick", "onDeleteRowClick", "onEditRowClick", "toolbar", "children"]);
  ...
  if (isEditing) {
    var FormWrapper = _antd.Form.create({
      ...
      return _react["default"].createElement(_react.Fragment, null, _react["default"].createElement(_.Button, {
        onClick: function onClick() {
          return setEditing(false);
        },
        icon: 'left'
      }, "Back"), _react["default"].createElement(_antd.Form, null, (0, _renderer.renderForm)(props, children), _react["default"].createElement(_.Button, {
        icon: 'save'
      }, "Save")));
    });
