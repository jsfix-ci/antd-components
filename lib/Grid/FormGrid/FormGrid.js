  ...
  if (isEditing) {
    var FormWrapper = _antd.Form.create({
      ...
      var onSaveClick = function onSaveClick() {
        form.validateFields(function (error, data) {
          if (error) {
      ...
      }), _react["default"].createElement(_antd.Form, null, (0, _renderer.renderForm)(props, children), _react["default"].createElement(_.SaveButton, {
        onClick: onSaveClick
      })));
    });
