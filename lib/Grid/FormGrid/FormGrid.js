...
var FormGrid = _antd.Form.create()(function (props) {
  var idProperty = props.idProperty,
      ...
      onSaveRowClick = props.onSaveRowClick,
      toolbar = props.toolbar,
      children = props.children,
      locale = props.locale,
      restProps = _objectWithoutProperties(props, ["idProperty", "dataSource", "onAddRowClick", "onDeleteRowClick", "onEditRowClick", "onSaveRowClick", "toolbar", "children", "locale"]);
  ...
  var onSaveClick = function onSaveClick(data) {
    setEditing(false);
  ...
  if (isEditing) {
    var FormWrapper = _antd.Form.create({
      ...
      var handleSubmit = function handleSubmit(e) {
        e.preventDefault();
        props.form.validateFields(function (error, data) {
          if (error) {
...
FormGrid.defaultProps = {
  idProperty: 'id',
  onAddRowClick: _helper.emptyFn,
  onEditRowClick: _helper.emptyFn,
  onDeleteRowClick: _helper.emptyFn,
  onSaveRowClick: _helper.emptyFn,
  toolbar: false,
  locale: 'en-EN',
  dataSource: []
};
FormGrid.propTypes = {
  ...
  onAddRowClick: _propTypes["default"].func,
  onEditRowClick: _propTypes["default"].func,
  onDeleteRowClick: _propTypes["default"].func,
  onSaveRowClick: _propTypes["default"].func,
