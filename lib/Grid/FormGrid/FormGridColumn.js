 ...
 * @constructor
 */
var FormGridColumn = function FormGridColumn(props) {
...
exports.FormGridColumn = FormGridColumn;
FormGridColumn.defaultProps = {
  type: 'text'
};
FormGridColumn.propTypes = {
  dataIndex: _propTypes["default"].string,
  fieldType: _propTypes["default"].oneOf(['string', 'object', 'boolean', 'image', 'html', 'list'])
};