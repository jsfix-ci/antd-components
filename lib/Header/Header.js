...
var Header = function Header(props) {
  ...
  if (!menuRoutes) extraBP = (0, _2.sumBreakPoints)(extraBP, menuBP);
  ...
  var renderMenu = function renderMenu() {
    return menuRoutes ? _react["default"].createElement(_antd.Col, _extends({}, menuBP, {
      style: menuStyle
    }), _react["default"].createElement(_.Flyout, _extends({
      routes: menuRoutes
    }, menuProps))) : null;
  };
  ...
  return _react["default"].createElement(_react.Fragment, null, _react["default"].createElement(_.MotionDrawer, {
    width: 300,
    open: open,
    onChange: function onChange(v) {
      return setOpen(v);
    }
  }, _react["default"].createElement(_.SideNavi, _extends({
