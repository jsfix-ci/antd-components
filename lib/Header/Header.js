...
var _Navigation = require("@root/Navigation");

var _Header = require("@root/Header");

var _Themes = require("@root/Themes");
...
var Header = function Header(props) {
  var extra = props.extra,
      ...
      restProps = _objectWithoutProperties(props, ["extra", "extraBreakpoints", "logo", "menuBreakpoints", "menuPosition", "menuProps", "menuRoutes", "siderRoutes", "siderProps", "version", "children"]);
  ...
  if (!menuRoutes) extraBP = (0, _Header.sumBreakPoints)(extraBP, menuBP);
  if (!extra) menuBP = (0, _Header.sumBreakPoints)(menuBP, extraBP);
  var burgerStyle = {
  ...
  return _react["default"].createElement(_react.Fragment, null, _react["default"].createElement(_root.MotionDrawer, {
    width: 300,
    open: open,
  ...
  }, sideNaviProps))), _react["default"].createElement(AntdHeader, _extends({
